<x-layout.app>
        ...
        <div class='space-y-16 mt-14'>
            <div class='space-y-6'>
                ...
                <div class='space-y-12'>
                    <p>I am an experienced, full-stack software engineer from Westfield, Indiana. My focus in my career
                        has been web apps that enable people to work with data. I am now working as an engineering
                        manager at dbt Labs, building a web-based IDE for analytics engineers.</p>
                    <p>At work, I am happiest working closely with product and design to navigate tradeoffs and to ship
                        quickly. I am passionate about code review and testing.</p>
                    <p>I believe in working hard and living slow. I enjoy life with my wife and my dog. I am fortunate
                        enough to enjoy leisure time, which is filled with walks, wine, books, and games.</p>
                </div>
            </div>
            <div class='mt-14'>
                ...
                <div class='space-y-12'>
                    <p x-data="{
                        ...
                        You can email me at
                        <span class='tooltip tooltip-primary' x-bind:class="showFeedback && 'tooltip-open'"
    ...
    <div class='flex justify-start space-x-8'>
        ...
        <a href='{{ route('scorecards.create') }}' wire:navigate class='link link-primary'>Scorecards</a>
    </div>
