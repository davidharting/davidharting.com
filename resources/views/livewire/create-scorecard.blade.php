<div class='mt-8 md:w-2/3 xl:w-1/2'>
    <form class='w-full space-y-8' wire:submit='create'>
        <x-form.input name='title' wire:model='title' label='Title' required placeholder='Euchre with in-laws' />
        ...
        <div class='mt-4 space-y-8'>
            @for ($i = 0; $i < $playerCount; $i++)
                <x-form.input type='text' name='names.{{ $i }}' label='Name of player {{ $i + 1 }}'
